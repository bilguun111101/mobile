    ...
    <>
      ...
      <View className='mt-[31px]'>
        <Pressable className="bg-[#FF3002] rounded-[3px] py-[14px] active:bg-[#FF0000]" onPressOut={onSubmit}>
          <Text className="text-center text-white font-normal text-[12px]">Log in</Text>
        </Pressable>
      </View>
    </>
  )
    ...
    <View className='mt-[40px]'>
      ...
      <View className='border-t border-[#CCCCCC] flex-row pt-[15px] justify-around'>
        ...
        <Pressable onPress={toggle}>
          <Text className='text-[#0232DD] underline font-normal text-[12px]'>Create an accound</Text>
        </Pressable>
      </View>
    </View>
  )
