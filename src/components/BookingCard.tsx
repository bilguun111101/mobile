...
const BookingCard = ({ item }: CardProps) => {
    ...
    return (
        ...
        >
            ...
            <Text className='absolute top-2 left-3 text-white text-tx font-bold' >{item.details.make}</Text>
            <Text className='absolute top-6 left-3 text-white text-[10px] font-medium' >{item.details.model}</Text>
